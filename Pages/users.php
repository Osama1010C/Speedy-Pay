...
$db = new Database();
session_start();
$useripa = $_SESSION["searchedIPA"];
$query = "SELECT * FROM users WHERE IPA = $useripa";
...
body {
  overflow: hidden;
  background: #131b1e url("../img/bg.jpg") no-repeat center center fixed;
...
.profile-card {
  ...
  -webkit-border-radius: 50%;
  border-radius: 50%;
  -webkit-box-shadow: 0px 3px 6px rgba(0, 0, 0, 0.16), 20px 14px 6px 12px black;
  box-shadow: 0px 3px 6px rgba(0, 0, 0, 0.16), 0px 0px 0px 13px black;
...
<aside class="profile-card">
  <header>
    ...
    <a target="_blank" href="#">
      <img src="../imgs/users-2.png" class="hoverZoomLink">
    </a>
