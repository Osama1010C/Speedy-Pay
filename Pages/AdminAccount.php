...
body {
  overflow: hidden;
  background: #c42525 url("../img/bg.jpg") no-repeat center center fixed;
...
.profile-card {
  ...
  box-shadow: 0px 3px 6px rgba(0, 0, 0, 0.16), 12px 1px 20px 0px black;
...
<aside class="profile-card">
  <header>
    <!-- here’s the avatar -->
    <a target="" href="">
      <img src="../imgs/adminprof.jpg" class="hoverZoomLink">
    </a>
